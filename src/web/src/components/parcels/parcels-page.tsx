...
import { Package, PackagePlus, Printer, FileText } from "lucide-react";
  ...
  return (
    <>
      <ListPageHeader
        ...
        description="Parcels registered and awaiting processing at the depot. Select one or more rows to download thermal or A4 labels."
      ...
      {data.length === 0 ? (
        ...
        <>
          <div className="mb-4 flex flex-col gap-2 rounded-2xl border border-border/60 bg-card/80 px-5 py-4 text-sm shadow-sm sm:flex-row sm:items-center sm:justify-between">
