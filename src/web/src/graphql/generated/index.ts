...
export type GetRoutesQuery = { __typename?: 'Query', routes: Array<{ __typename?: 'Route', id: string, vehicleId: string, vehiclePlate?: string | null, driverId: string, driverName?: string | null, stagingArea: StagingArea, startDate: string, endDate?: string | null, startMileage: number, endMileage: number, totalMileage: number, status: RouteStatus, parcelCount: number, parcelsDelivered: number, createdAt: string, updatedAt?: string | null, cancellationReason?: string | null }> };
...
export type GetRouteQuery = { __typename?: 'Query', route?: { __typename?: 'Route', id: string, vehicleId: string, vehiclePlate?: string | null, driverId: string, driverName?: string | null, stagingArea: StagingArea, startDate: string, endDate?: string | null, startMileage: number, endMileage: number, totalMileage: number, status: RouteStatus, parcelCount: number, parcelsDelivered: number, createdAt: string, updatedAt?: string | null, cancellationReason?: string | null, assignmentAuditTrail: Array<{ __typename?: 'RouteAssignmentAuditEntry', id: string, action: RouteAssignmentAuditAction, previousDriverId?: string | null, previousDriverName?: string | null, newDriverId: string, newDriverName: string, previousVehicleId?: string | null, previousVehiclePlate?: string | null, newVehicleId: string, newVehiclePlate: string, changedAt: string, changedBy?: string | null }> } | null };
...
export type CreateRouteMutation = { __typename?: 'Mutation', createRoute: { __typename?: 'Route', id: string, vehicleId: string, vehiclePlate?: string | null, driverId: string, driverName?: string | null, stagingArea: StagingArea, startDate: string, endDate?: string | null, startMileage: number, endMileage: number, totalMileage: number, status: RouteStatus, parcelCount: number, parcelsDelivered: number, createdAt: string, updatedAt?: string | null, cancellationReason?: string | null } };
...
export type UpdateRouteAssignmentMutation = { __typename?: 'Mutation', updateRouteAssignment?: { __typename?: 'Route', id: string, vehicleId: string, vehiclePlate?: string | null, driverId: string, driverName?: string | null, stagingArea: StagingArea, startDate: string, endDate?: string | null, startMileage: number, endMileage: number, totalMileage: number, status: RouteStatus, parcelCount: number, parcelsDelivered: number, createdAt: string, updatedAt?: string | null, cancellationReason?: string | null } | null };
...
export type CancelRouteMutation = { __typename?: 'Mutation', cancelRoute?: { __typename?: 'Route', id: string, vehicleId: string, vehiclePlate?: string | null, driverId: string, driverName?: string | null, stagingArea: StagingArea, startDate: string, endDate?: string | null, startMileage: number, endMileage: number, totalMileage: number, status: RouteStatus, parcelCount: number, parcelsDelivered: number, createdAt: string, updatedAt?: string | null, cancellationReason?: string | null } | null };
