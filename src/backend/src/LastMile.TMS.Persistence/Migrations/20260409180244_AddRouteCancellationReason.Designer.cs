...
namespace LastMile.TMS.Persistence.Migrations
{
    ...
    [Migration("20260409180244_AddRouteCancellationReason")]
    partial class AddRouteCancellationReason
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LastMile.TMS.Domain.Entities.BinLocation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<Guid>("StorageAisleId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("StorageAisleId", "NormalizedName")
                        .IsUnique();
            ...
            modelBuilder.Entity("LastMile.TMS.Domain.Entities.DeliveryConfirmation", b =>
                {
                    ...
                    b.Property<string>("SignatureImageKey")
                        .HasMaxLength(512)
                        .HasColumnType("character varying(512)");
            ...
            modelBuilder.Entity("LastMile.TMS.Domain.Entities.InboundManifestLine", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("ManifestId", "ParcelId")
                        .IsUnique();

                    b.ToTable("InboundManifestLines", (string)null);
                });

            modelBuilder.Entity("LastMile.TMS.Domain.Entities.InboundReceivingException", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("SessionId", "ExceptionType", "Barcode")
                        .IsUnique();

                    b.ToTable("InboundReceivingExceptions", (string)null);
                });

            modelBuilder.Entity("LastMile.TMS.Domain.Entities.InboundReceivingScan", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("SessionId", "Barcode")
                        .IsUnique();

                    b.ToTable("InboundReceivingScans", (string)null);
                });
            ...
            modelBuilder.Entity("LastMile.TMS.Domain.Entities.RouteAssignmentAuditEntry", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<Guid>("NewDriverId")
                        .HasColumnType("uuid");

                    b.Property<string>("NewDriverName")
                        .IsRequired()
                        .HasMaxLength(200)
                        .HasColumnType("character varying(200)");
                    ...
                    b.Property<string>("NewVehiclePlate")
                        .IsRequired()
                        .HasMaxLength(50)
                        .HasColumnType("character varying(50)");

                    b.Property<Guid?>("PreviousDriverId")
                        .HasColumnType("uuid");

                    b.Property<string>("PreviousDriverName")
                        .HasMaxLength(200)
                        .HasColumnType("character varying(200)");
                    ...
                    b.Property<string>("PreviousVehiclePlate")
                        .HasMaxLength(50)
                        .HasColumnType("character varying(50)");
                    ...
                    b.HasIndex("RouteId", "ChangedAt");

                    b.ToTable("RouteAssignmentAuditEntries", (string)null);
                });

            modelBuilder.Entity("LastMile.TMS.Domain.Entities.StorageAisle", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("StorageZoneId", "NormalizedName")
                        .IsUnique();

                    b.ToTable("StorageAisles", (string)null);
                });

            modelBuilder.Entity("LastMile.TMS.Domain.Entities.StorageZone", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("DepotId", "NormalizedName")
                        .IsUnique();
            ...
            modelBuilder.Entity("LastMile.TMS.Domain.Entities.BinLocation", b =>
                {
                    b.HasOne("LastMile.TMS.Domain.Entities.Zone", "DeliveryZone")
                        .WithMany("AssignedBinLocations")
                        .HasForeignKey("DeliveryZoneId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("LastMile.TMS.Domain.Entities.StorageAisle", "StorageAisle")
                        .WithMany("BinLocations")
                        .HasForeignKey("StorageAisleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("DeliveryZone");

                    b.Navigation("StorageAisle");
                });
            ...
            modelBuilder.Entity("LastMile.TMS.Domain.Entities.InboundReceivingException", b =>
                {
                    b.HasOne("LastMile.TMS.Domain.Entities.InboundManifestLine", "ManifestLine")
                        .WithMany("Exceptions")
                    ...
                    b.HasOne("LastMile.TMS.Domain.Entities.InboundReceivingSession", "Session")
                        .WithMany("Exceptions")
            ...
            modelBuilder.Entity("LastMile.TMS.Domain.Entities.StorageAisle", b =>
                {
                    b.HasOne("LastMile.TMS.Domain.Entities.StorageZone", "StorageZone")
                        .WithMany("StorageAisles")
            ...
            modelBuilder.Entity("LastMile.TMS.Domain.Entities.Route", b =>
                {
                    b.Navigation("AssignmentAuditTrail");
                });
            ...
            modelBuilder.Entity("LastMile.TMS.Domain.Entities.StorageZone", b =>
                {
                    b.Navigation("StorageAisles");
                });

            modelBuilder.Entity("LastMile.TMS.Domain.Entities.Zone", b =>
                {
                    b.Navigation("AssignedBinLocations");
