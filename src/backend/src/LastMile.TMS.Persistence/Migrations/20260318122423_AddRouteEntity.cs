    ...
    public partial class AddRouteEntity : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RouteParcels", x => new { x.ParcelsId, x.RouteId });
                    table.ForeignKey(
                        name: "FK_RouteParcels_Parcels_ParcelsId",
                        column: x => x.ParcelsId,
                        principalTable: "Parcels",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_RouteParcels_Routes_RouteId",
                        column: x => x.RouteId,
